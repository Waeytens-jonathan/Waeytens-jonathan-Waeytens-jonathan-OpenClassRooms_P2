...
if __name__=="__main__":
   ...
   print(book.get_book('https://books.toscrape.com/catalogue/the-cuckoos-calling-cormoran-strike-1_239/index.html')["rating"])#1
   print(book.get_book('https://books.toscrape.com/catalogue/career-of-evil-cormoran-strike-3_137/index.html')["rating"])
   print(book.get_book('https://books.toscrape.com/catalogue/extreme-prey-lucas-davenport-26_154/index.html')["rating"])
